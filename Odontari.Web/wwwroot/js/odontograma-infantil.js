/**
 * Odontograma infantil - 20 dientes temporales FDI
 * Numeración: 51-55, 61-65 (superior); 71-75, 81-85 (inferior)
 * Misma lógica, colores y funciones que odontograma adulto; estados: erupción, exfoliación, caries, sellantes, traumatismos.
 */
(function () {
  const FDI_SUPERIOR = [
    [55, 54, 53, 52, 51],
  ...
  function render() {
    ...
    labelSup.textContent = 'Arcada superior (temporal)';
    ...
    labelInf.textContent = 'Arcada inferior (temporal)';
